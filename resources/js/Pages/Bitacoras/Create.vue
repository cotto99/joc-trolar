...
function submit() {
    form.post(route('bitacoras.store'))
}
</script>

<template>
    <AuthenticatedLayout>
        <template #header>📓 Nueva Bitácora</template>

        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-6">Nuevo Registro</h2>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input v-model="form.titulo" type="text"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500"
                               placeholder="Ej: Visita de inspección bodega 3">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.descripcion" rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500"
                                  placeholder="Describe el evento detalladamente..."></textarea>
