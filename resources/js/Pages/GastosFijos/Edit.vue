...
const form = useForm({
    nombre:        props.gastoFijo.nombre,
    descripcion:   props.gastoFijo.descripcion ?? '',
    monto_mensual: props.gastoFijo.monto_mensual,
    dia_pago:      props.gastoFijo.dia_pago,
})

function submit() {
    form.put(route('gastos-fijos.update', props.gastoFijo.id))
}
</script>

<template>
    <AuthenticatedLayout>
        <template #header>📌 Editar Gasto Fijo</template>

        <div class="max-w-xl mx-auto">
            <div class="bg-white rounded-xl shadow p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-6">Editar Gasto Fijo</h2>
